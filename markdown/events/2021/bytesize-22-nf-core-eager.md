...
[0:00] (host) Hi everyone, thanks for joining us for the next in our series of bytesized talks that are focused on nf-core pipelines. We're joined by James Fellows Yates from the Max Planck Institute for evolutionary anthropology in Germany today and he will be presenting the nf-core/eager pipeline. As usual we're on zoom and we're also back on youtube, live this time, so if you have any questions during the talk please add them to the chat box at any point during the session and i will read them out at the end. Thanks very much for volunteering to present today, James. Over to you.
